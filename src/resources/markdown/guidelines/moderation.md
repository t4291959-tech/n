# TSANAL Moderation Expectations
...
## Our expectations
When moderating TSANAL, we expect you to handle conflicts, disagreements, spam, etc with a mature and formal fashion.
...
Profanity (curse/swear/brainrot words) or inappropriate messages ***will not be tolerated.***

On top of this, ***do not do anything that intentionally creates problems for the TSANAL team.***
...
- "the content is too sexual for TSANAL"
...
## Base requirements for a project + Projects that display websites (iframes) + TSANAL Mods / Forks
...
## Credit + Spam / Project updates + Projects uploaded that were shared on Medias (medias Reuploads)
Projects reuploaded from medias ***should NOT be punished*** under this rule if they are from the same creator.
...
# Bad usernames
A "bad" username refers to if a username contains brainrot/swear/curse words, derrogatory terms, inappropriate usernames/websites, or anything similar.
