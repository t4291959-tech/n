...
Tsanal Projects that you have saved to your computer were not directly affected by this outage.
Restore points in the Tsanal editor were also not affected.
...
This process did complete and on the 20th, assets for Tsanal projects were on Backblaze.
...
## Server Outage
The next day, January 21st, we could too long connect to the tsanal projects server.

Ianyourgod (tsanal server developer) could not connect to the live Tsanal server, could not login to our Oracle account, and the Tsanal server refused connections from any source.
...
**This section is only for transparency on what we tried, and not for harrassment.** Do not contact Oracle for anything related to Tsanal.
...
## Our Responsibility
Tsanal is not liable for any loss of data, but we still should have setup backups for your accounts & projects before anything like this could have happened.
